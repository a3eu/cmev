            ...
            <div className="flex-1">
              ...
              {!isPreRelease && (
                <div className="flex flex-wrap gap-3 mb-8">
                  <a
                    href="https://tarareando.bandcamp.com/track/friling"
                    target="_blank"
                  ...
                  <a
                    href="https://www.youtube.com/watch?v=zSfRachiq0E"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center gap-2 bg-[#FF0000] text-white text-sm font-medium px-5 py-2.5 rounded-full hover:bg-[#cc0000] transition-colors"
                  >
