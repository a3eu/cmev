        ...
        <section className="relative">
          <div className="relative">
            ...
            <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2">
              <Button 
                size="lg"
                className="bg-red-600 hover:bg-red-700 text-white font-bold px-18 py-9 text-3xl"
      ...
      <section id="about" className="py-20 px-4 bg-[#f0f8f8]">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="flex flex-col items-center p-4 md:p-16 mb-8 gap-6">
            <Button
                className="bg-[#166579] hover:bg-[#4e788b] text-white font-bold px-8 py-4 md:px-20 md:py-6 text-4xl md:text-6xl rounded-2xl w-full max-w-4xl"
